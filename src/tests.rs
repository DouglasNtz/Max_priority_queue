...
fn test_insert_one_a_one() {
    ...
    let max_heap = vec![(10, AnyObject { id: 0 }), (9, AnyObject { id: 3 }), (10, AnyObject { id: 12 }),
                        (9, AnyObject { id: 8 }), (5, AnyObject { id: 10 }), (3, AnyObject { id: 5 }), (6, AnyObject { id: 14 }),
                        (0, AnyObject { id: 7 }), (5, AnyObject { id: 1 }), (0, AnyObject { id: 4 }), (1, AnyObject { id: 9 }),
                        (0, AnyObject { id: 11 }), (2, AnyObject { id: 2 }), (3, AnyObject { id: 6 }), (5, AnyObject { id: 13 })];
...
fn test_insert_full() {
    ...
    let mut priority_queue = PriorityQueue::new(elements);

    let max_heap = vec![(10, AnyObject { id: 0 }), (9, AnyObject { id: 3 }), (10, AnyObject { id: 12 }),
                        (9, AnyObject { id: 8 }), (5, AnyObject { id: 10 }), (3, AnyObject { id: 5 }), (6, AnyObject { id: 14 }),
                        (0, AnyObject { id: 7 }), (5, AnyObject { id: 1 }), (1, AnyObject { id: 9 }), (0, AnyObject { id: 4 }),
                        (0, AnyObject { id: 11 }), (2, AnyObject { id: 2 }), (5, AnyObject { id: 13 }), (3, AnyObject { id: 6 })];
...
fn test_same_extract() {
    ...
    let mut priority_queue_one_a_one = PriorityQueue::new(vec![]);
    ...
    let mut priority_queue_full = PriorityQueue::new(elements);
